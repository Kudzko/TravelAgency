package by.andersen.kudko.dao.connection.first;
...
public class ConnectionPool {
    ...
    public void closeConnection(Connection connection) throws ConnectionPoolException {
        try {
            ...
            log.warn("Database access error occured. Connection haven't closed", e);
            throw new ConnectionPoolException("Database access error occured. Connection haven't closed", e);
        }
