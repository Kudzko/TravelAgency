...
import by.andersen.kudko.dao.jdbctemplate.daointerface.CrudDAO;
import by.andersen.kudko.dao.jdbctemplate.daointerface.IAbstractDAO;
...
@Log4j2
public abstract class AbstractDAO<E extends BEntity, PK extends Integer> implements CrudDAO<E>, IAbstractDAO<E, PK> {
