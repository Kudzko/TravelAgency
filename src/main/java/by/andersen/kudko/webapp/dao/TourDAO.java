...
public class TourDAO extends AbstractDAO<Tour, Integer> {
    public final String INSERT_TUOR = "INSERT INTO `travel_agency`.`tour` (`country`, `hotel`, `review`) VALUES (?, ?, ?);";
    ...
    @Override
    public Tour resultsetStringToObject(ResultSet resultSet) throws SQLException {
        Tour tour = new Tour();
